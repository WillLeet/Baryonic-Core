...
//
//  My first actual enemy! Moves semi-aggressively and periodically fires a basic bullet at the player
...
class Basic_Enemy: Enemy{
    ...
    convenience init(scale: CGFloat, game_world: GameScene){
        self.init(sprite: "Basic Enemy", scale: scale, game_world: game_world, hp: 4)
